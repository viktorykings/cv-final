...
export const CvProjectsPage = lazy(() => import('../pages/Cvs/CvProjectsPage.tsx'))
export const SkillsPage = lazy(() => import('../pages/SkillsPage.tsx'))
export const CvSkillsPage = lazy(() => import('../pages/Cvs/CvProjectsPage.tsx'))
...
export const Cvs = lazy(() => import('../pages/Profile/CVs.tsx'))
